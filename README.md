...
### <a name="get_calculate_for_ap_idays_async"></a>![Method: ](https://apidocs.io/img/method.png "io.apimatic.examples.controllers.SimpleCalculatorController.getCalculateForAPIdaysAsync") getCalculateForAPIdaysAsync

> Calculates the expression using the specified operation


```java
void getCalculateForAPIdaysAsync(
        final GetCalculateForAPIdaysInput input,
...
```java
GetCalculateForAPIdaysInput collect = new GetCalculateForAPIdaysInput();
...
simpleCalculator.getCalculateForAPIdaysAsync(collect, new APICallBack<Double>() {
